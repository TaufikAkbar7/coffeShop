<template>
  <Wrapper className="h-60 flex flex-col justify-center items-center mt-52 ml-44 z-20 border border-thirdColor
        rounded-2xl">
    <div
      class="
        container
      ...
      "
    >
      <Title className="text-4xl mt-5 text-secondaryColor font-bold" title="Popular Now" />
